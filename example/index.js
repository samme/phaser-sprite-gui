...
(function() {
  "use strict";
  var Phaser, SpriteGUI, bg, create, cursors, droid, droidGui, emitHeart, game, hearts, init, jumpButton, jumpTimer, mixin, pack, packGui, player, playerGui, preload, render, rocks, shutdown, update;
